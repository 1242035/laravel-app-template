...
class ProfileRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'first_name_kana' => 'nullable|max:64|regex:' . User::VALIDATE_KANA,
            'last_name_kana'  => 'nullable|max:64|regex:' . User::VALIDATE_KANA,
            ...
            'phone_number'    => 'nullable|max:16|regex:' . User::VALIDATE_PHONE,
